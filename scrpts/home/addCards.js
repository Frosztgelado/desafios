function addCards() {
    var cards = [
        {
            ...
            content: "Crie uma calculadora que possa realizar operações básicas como adição, subtração, multiplicação e divisão.",
    ...
    for (let clist = 0; clist < cards.length; clist++){
        ...
        card.className = "card";
        card.innerHTML = "<h4>" + cards[clist].title + "</h4><p>" + cards[clist].content + "</p>";
